...
qsub -pe alloc 2 -N $TAG $QCMD \
  zcat $FASTQ1 \| head -40000 \| fastx_clipper -Q33 -v -n -a $ADAPTER_1 -o ${OUT1}__TMP.fastq \> ${OUT1}__CLIP.log
qsub -pe alloc 2 -N $TAG $QCMD \
  zcat $FASTQ2 \| head -40000 \| fastx_clipper -Q33 -v -n -a $ADAPTER_2 -o ${OUT2}__TMP.fastq \> ${OUT2}__CLIP.log
$QSYNC $TAG
